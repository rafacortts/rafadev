...
const About = () => {
  return (
    ...
    <div className=" shadow-md container mt-12 text-white">
      ...
      <div className=" min-h-[500px] flex items-center justify-center">
        <div className="space-y-5 justify-center p-12">
          ...
          <div className="space-x-4 flex justify-center">
              <a href='#' className="bg-blue-700 border-2 border-blue-700 text-white p-2 rounded-full transition hover:bg-transparent hover:text-whithe hover:border-2 hover:border-blue-700 "> Entre em Contato</a>
          </div>
        </div>
      </div>
    </main>
